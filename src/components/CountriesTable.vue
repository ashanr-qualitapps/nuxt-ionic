  ...
  <ion-content>
    <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-primary-dark dark:text-gray-400">
          <tr>
        ...
        <tbody>
          <tr v-for="country in countries" :key="country.cca3" class="bg-white border-b dark:bg-primary-dark dark:border-gray-700">
